...
LONG_TAKE_PROFIT_PCT = 0.1   # take profit if price rises this much

# ── Short parameters (tuned independently) ──
SHORT_SCORE_MIN      = 0.50   # higher bar - shorts need stronger confirmation
...
SHORT_TAKE_PROFIT_PCT= 0.1   # take profit if price falls this much
...
def plot_open_positions():
    ...
    print(f"  75Th open positions/day  : {percentile:.1f}")
